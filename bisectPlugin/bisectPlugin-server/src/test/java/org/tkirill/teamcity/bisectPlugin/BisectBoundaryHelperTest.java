...
public class BisectBoundaryHelperTest {
    @Test
    ...
    @Test
    public void GetNextStep_IntervalLengthTwoStartsFromZeroAndSuccess_ReturnsLater() throws Exception {
        BisectStep actual = BisectBoundaryHelper.getNextStep(new BisectStep(0, 2), true);
        assertBuildStep(actual, 0, 1);
    }

    @Test
    public void GetNextStep_IntervalLengthTwoStartsFromNonZeroAndSuccess_ReturnsLater() throws Exception {
        BisectStep actual = BisectBoundaryHelper.getNextStep(new BisectStep(14, 16), true);
        assertBuildStep(actual, 14, 15);
    }

    @Test
    public void GetNextStep_IntervalLengthTwoStartsFromZeroAndFail_ReturnsNull() throws Exception {
        BisectStep actual = BisectBoundaryHelper.getNextStep(new BisectStep(0, 2), false);
        assertNull(actual);
    }
